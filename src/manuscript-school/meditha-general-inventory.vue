...
<tr><td style="vertical-align: top;"><h5 class="primary-color">{{$t('notesOnHandwrittenTradition')}} <i class="fa fa-info-circle fa-lg" :title="$t('notesOnHandwrittenTraditionHelp')"></i> :</h5></td><td>
 ...
 <tr v-show="legendier"><td class="sublabel"><h5 class="primary-color">{{$t('legendier')}}:</h5></td><td>  {{legendier}} <span v-show="legendierPct"> ({{legendierPct}}%)</span></td></tr>
 <tr v-show="legendierPerCirculumAnni"><td class="sublabel"><h5 class="primary-color">{{$t('legendierPerCirculumAnni')}}:</h5></td><td>  {{legendierPerCirculumAnni}}<span v-show="legendierPerCirculumAnniPct"> ({{legendierPerCirculumAnniPct}}%)</span> </td></tr>
<tr v-show="passionnaire"><td class="sublabel"><h5 class="primary-color">{{$t('passionnaire')}}:</h5></td><td>  {{passionnaire}}<span v-show="passionnairePct"> ({{passionnairePct}}%)</span> </td></tr>
<tr v-show="libellus"><td class="sublabel"><h5 class="primary-color">{{$t('libellus')}}:</h5></td><td>  {{libellus}} <span v-show="libellusPct"> ({{libellusPct}}%)</span></td></tr>
<tr v-show="anthology"><td class="sublabel"><h5 class="primary-color">{{$t('anthology')}}:</h5></td><td>  {{anthology}} <span v-show="anthologyPct"> ({{anthologyPct}}%)</span></td></tr>
<tr v-show="others"><td class="sublabel"><h5 class="primary-color">{{$t('others')}}:</h5></td><td>  {{others}}<span v-show="othersPct"> ({{othersPct}}%)</span> </td></tr>
